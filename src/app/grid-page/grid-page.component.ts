...
import 'ids-enterprise-wc/enterprise-wc/components/ids-data-grid/ids-data-grid';
...
@Component({
    ...
    template: `
        ...
        <p>This grid has <strong>100 rows</strong> with <strong>page-size="10"</strong>. Pagination should show 10 pages.</p>

        <div class="manual-test">
            <h4>Manual Detach/Reattach Test</h4>
            <p>
                Click "Detach" to remove the grid from the DOM, then "Reattach" to put it back. After reattachment, pagination will be
                broken.
            </p>
...
export class GridPageComponent implements AfterViewInit {
    ...
    ngAfterViewInit(): void {
        ...
        grid.columns = [
            ...
            { id: 'productName', name: 'Product Name', field: 'productName', width: 200 },
    ...
    detachGrid(): void {
        ...
        if (container && grid && grid.parentNode) {
            ...
            console.log('[BUG REPRO] Grid detached from DOM (disconnectedCallback fired)');
        }
    }
    ...
    reattachGrid(): void {
        ...
        if (container && this.#detachedGrid) {
            ...
            console.log('[BUG REPRO] Grid reattached to DOM (connectedCallback fired)');
            console.log('[BUG REPRO] Try clicking pagination buttons — they will not work.');
        }
    }
}
